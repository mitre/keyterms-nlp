...
public class OptimaizeAnalyzer_UT {

    private static OptimaizeAnalyzer analyzer;

    @BeforeClass
    public static void setupAnalyzer() {
        analyzer = new OptimaizeAnalyzer();
    }
    ...
    public void analysis() {
        TestData.LANGUAGE_PHRASES.forEach((key, phrase) -> {
            ...
            if (!"zho-hant".equals(key)) {
                // Chinese cannot determine script.
