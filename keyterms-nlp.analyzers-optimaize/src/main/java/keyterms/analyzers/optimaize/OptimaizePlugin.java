...
/**
 * The analyzer plugin for the Optimaize based analyzers.
 */
public class OptimaizePlugin
        implements AnalyzerPlugin {
    /**
     * Constructor.
     */
    public OptimaizePlugin() {
        super();
    }
    ...
    public Set<AnalyzerFactory> getAnalyzerFactories() {
        ...
        factories.add(new AnalyzerFactory(
                new AnalyzerId("OPT"),
                OptimaizeAnalyzer.INPUT_CLASSES,
                OptimaizeAnalyzer.OUTPUT_FEATURES,
                OptimaizeAnalyzer.PRODUCES_RANKINGS,
                OptimaizeAnalyzer.PRODUCES_SCORES,
                OptimaizeAnalyzer::new));
        return factories;
    }
}