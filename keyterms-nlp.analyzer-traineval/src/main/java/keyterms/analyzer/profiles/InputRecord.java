...
/**
 * A simple container for records from the training and testing data input files.
 */
class InputRecord
        implements Serializable {

    private static final long serialVersionUID = -521537266663976872L;
    ...
    TextInfo getTextInfo() {
        ...
        textInfo.setSize(data.length);
        textInfo.setEncoding(encoding);
        textInfo.setLength(Encoding.decode(data, Encoding.getCharset(encoding)).length());
