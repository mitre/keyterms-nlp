...
public class TextTransformer_Spa
        extends TextTransformer {

    private static final Language SRC_LANG = Language.SPANISH;
    private static final Language TRG_LANG = Language.ENGLISH;

    public TextTransformer_Spa() {
        this(SRC_LANG,TRG_LANG);
    }

    public TextTransformer_Spa(Language source, Language target) {
        super(source,target);
    }

    @Override
    protected void initializeNormalizer() {
        normalizer = new Normalizer_Spa();
    }

    @Override
    protected void initializeStemmer() {
        stemmer = new Stemmer_Spa();
    }
