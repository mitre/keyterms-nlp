...
public class Normalizer_Fra
    ...
    public String normalizeForIndex(String input, boolean removeSpacesForIndex) {
        return StringNormalizer.normalizeForIndex(input, removeSpacesForIndex);
    }
    ...
    public String normalizeForScoring(String input) {
        return StringNormalizer.normalizeForScoring(input);
    }
    ...
    public String normalizeForDisplay(String input) {
        return StringNormalizer.normalizeForDisplay(input);
    }
