...
public class Normalizer_Eng_UT {

    private static final Normalizer_Eng NORM_ENG = new Normalizer_Eng();
    ...
    public void normalizeForIndex() {
        ...
        assertEquals(expected_spaces, NORM_ENG.normalizeForIndex(input, false));
        ...
        assertEquals(expected_noSpaces, NORM_ENG.normalizeForIndex(input, true));
    }
    ...
    public void normalizerForScoring() {
        ...
        assertEquals(expected, NORM_ENG.normalizeForScoring(input));
    }
    ...
    public void normalizeForDisplay() {
        ...
        assertEquals(expected, NORM_ENG.normalizeForDisplay(input));
    }
}