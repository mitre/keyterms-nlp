...
public class MorphAnalyzer_Ara_UT {

    private static final MorphAnalyzer_Ara MORPH_ARA = new MorphAnalyzer_Ara();
    ...
    public void getWordForms() {
        ...
        for (int i = 0; i < INPUT.length; i++) {
            List<WordForm> results = MORPH_ARA.getWordForms(INPUT[i]);
            if (results.size() == 1) {
