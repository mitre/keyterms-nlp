...
public class Normalizer_Ara_UT {

    private static final Normalizer_Ara NORM_ARA = new Normalizer_Ara();
    ...
    public void normalizeForIndex() {
        ...
        assertEquals(expected_spaces, NORM_ARA.normalizeForIndex(input, false));
        ...
        assertEquals(expected_noSpaces, NORM_ARA.normalizeForIndex(input, true));
    }
    ...
    public void normalizerForScoring() {
        ...
        assertEquals(expected, NORM_ARA.normalizeForScoring(input));
    }
    ...
    public void normalizeForDisplay() {
        ...
        assertEquals(expected, NORM_ARA.normalizeForDisplay(input));
    }
}