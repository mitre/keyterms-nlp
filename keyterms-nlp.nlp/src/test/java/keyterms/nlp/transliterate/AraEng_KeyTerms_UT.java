...
public class AraEng_KeyTerms_UT {
    ...
    public static void init()
            throws Exception {
        Path rulePath = TestFiles.getFilePath(Transliterators_UT.class, "rsc/ara-eng.KeyTerms.rules");
        String rules = Transliterators.loadIcuRules(rulePath);
        myTransliterator = new IcuTransliterator("ara-eng/KeyTerms", rules);
    }
