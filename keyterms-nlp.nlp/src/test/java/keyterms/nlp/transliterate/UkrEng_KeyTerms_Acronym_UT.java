...
public class UkrEng_KeyTerms_Acronym_UT {
    ...
    public static void init()
            throws Exception {
        Path rulePath = TestFiles.getFilePath(Transliterators_UT.class, "rsc/ukr-eng.KeyTerms_Acronym.rules");
        String rules = Transliterators.loadIcuRules(rulePath);
        myTransliterator = new IcuTransliterator("ukr-eng/KeyTerms_Acronym", rules);
    }
