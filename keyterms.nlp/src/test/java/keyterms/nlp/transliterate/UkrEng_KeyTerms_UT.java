...
public class UkrEng_KeyTerms_UT {
    ...
    public static void init()
            throws Exception {
        Path rulePath = TestFiles.getFilePath(Transliterators_UT.class, "rsc/ukr-eng.KeyTerms.rules");
        String rules = Transliterators.loadIcuRules(rulePath);
        myTransliterator = new IcuTransliterator("ukr-eng/KeyTerms", rules);
    }
