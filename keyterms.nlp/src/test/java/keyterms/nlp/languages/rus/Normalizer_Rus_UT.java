...
public class Normalizer_Rus_UT {

    private static final Normalizer_Rus NORM_RUS = new Normalizer_Rus();
    ...
    public void normalizeForIndex() {
        ...
        assertEquals(expected_spaces, NORM_RUS.normalizeForIndex(input, false));
        ...
        assertEquals(expected_noSpaces, NORM_RUS.normalizeForIndex(input, true));
    }
    ...
    public void normalizerForScoring() {
        ...
        assertEquals(expected, NORM_RUS.normalizeForScoring(input));
    }
    ...
    public void normalizeForDisplay() {
        ...
        assertEquals(expected, NORM_RUS.normalizeForDisplay(input));
    }
}