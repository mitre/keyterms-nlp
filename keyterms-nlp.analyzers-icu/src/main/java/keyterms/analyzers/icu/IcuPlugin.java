...
/**
 * The analyzer plugin for the ICU4J based analyzers.
 */
public class IcuPlugin
    ...
    public Set<AnalyzerFactory> getAnalyzerFactories() {
        ...
        factories.add(new AnalyzerFactory(
                new AnalyzerId("ICU"),
                IcuAnalyzer.INPUT_CLASSES,
                IcuAnalyzer.OUTPUT_FEATURES,
                IcuAnalyzer.PRODUCES_RANKINGS,
                IcuAnalyzer.PRODUCES_SCORES,
                IcuAnalyzer::new));
        return factories;
    }
}